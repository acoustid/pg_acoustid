...
static inline char *Base64Encode(const unsigned char *first, const unsigned char *last, char *dest, bool terminate) {
...
static inline unsigned char *Base64Decode(const char *first, const char *last, unsigned char *dest) {
