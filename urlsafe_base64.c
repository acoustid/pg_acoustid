 ...
 */
int
urlsafe_b64_encode(const char *src, int len, char *dst, int dstlen)
{
	char	   *p;
	const char *s,
			   *end = src + len;
 ...
 */
int
urlsafe_b64_decode(const char *src, int len, char *dst, int dstlen)
{
 ...
 */
int
urlsafe_b64_enc_len(int srclen)
{
 ...
 */
int
urlsafe_b64_dec_len(int srclen)
{
	return (srclen * 3) >> 2;
}
